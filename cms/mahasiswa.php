...
<head>
    ...
    <title>Mahasiswa | Pusat Seni</title>
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="mahasiswa.php">
                    ...
                    <span class="fw-bold">Mahasiswa</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        <h2 class="text-center mb-3 text-black">Daftar Mahasiswa</h2>

                        <input id="myInput" type="text" placeholder="Search..">
                        <br>

                        <a href="tambah_mahasiswa.php">
                            <button type="button" class="btn btn-dark mt-2">Tambah Mahasiswa</button>
                        </a>
                        <table class="table table-hover text-center mt-2" id="myTable">
                            ...
                            <tbody>
                                <?php
                                $sSQL = "";
                                $sSQL = "select * from tb_users where role = 'mahasiswa' order by id_user";
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="delete_mahasiswa.php?email=<?php echo $email; ?>"
