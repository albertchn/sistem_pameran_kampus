...
<head>
    ...
    <title>Kurasi Karya | Pusat Seni</title>
...
<body>
    ...
    <div class="container">
        <h2 class="text-center my-3">Kurasi Karya</h2>
        ...
        <div class="row">
            ...
            <div class="col col-6">
                <form action="simpan_kurasi_karya.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="number" class="form-control" id="skor"
                            placeholder="Masukkan judul karya..." name="skor" required autocomplete="off">
                    </div>
                    <div class="mb-3">
                        <label for="catatan">Catatan</label>
                        <textarea type="text" class="form-control" id="catatan"
                            placeholder="Masukan catatan..." name="catatan" required autocomplete="off"></textarea>
                    </div>
